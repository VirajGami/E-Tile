...
<h1 style="font-family: cursive;font-size: 50px;padding-top: 30px;color: grey">Update Product</h1>
     ...
     int id = Integer.parseInt(request.getParameter("id"));
      ...
      %> 
                     <form style="padding-top: 10px" action="updateproductcat" enctype="multipart/form-data"  method="POST">
                         ...
                         <input type="text" readonly  name="id" value=<%out.println(id); %>> <br>
                                    ...
                                    <td> <select id ="cat" name="cat"  onchange="jsFunction(this.value);"  style="width: 50%;height: 30px"required>
                                            <option value=" "></option>
                                    <%  while(rs.next()){ %>
