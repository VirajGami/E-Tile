...
height: 100px" onmouseleave="logout1()">
    ...
    <table>
        <tr>
            <td>
<h1 style="font-family: cursive;font-size: 50px;padding-top: 30px;color: grey">Delete Product  </h1>
 
<form style="padding-top: 10px" action="deleteproduct.jsp">
    <table>
      ...
      <tr>
        <td colspan="2" ><input type="submit" value="Delete Product " class="btn" name="submit"></td>
      </tr>
    </table>
